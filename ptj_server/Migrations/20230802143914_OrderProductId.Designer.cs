...
namespace ptj_server.Migrations
{
    ...
    [Migration("20230802143914_OrderProductId")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ptj_server.Models.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ptj_server.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ptj_server.ViewModels.ProductViewModel", b =>
                {
                    b.Property<bool?>("active")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("ptj_server.Models.Cart", b =>
                {
                    ...
                    b.HasOne("ptj_server.Models.OrderProduct", "Order")
                        .WithMany("Carts")
                    ...
                    b.HasOne("ptj_server.Models.ProductDetail", "ProductDetail")
                        .WithMany("Carts")
